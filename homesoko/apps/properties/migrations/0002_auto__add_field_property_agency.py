...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Property.agency'
        db.add_column(u'properties_property', 'agency',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='property', to=orm['auth.User']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Property.agency'
        db.delete_column(u'properties_property', 'agency_id')
